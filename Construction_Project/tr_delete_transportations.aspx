<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="tr_delete_transportations.aspx.cs" Inherits="Construction_Project.tr_delete_transportations" %>
                ...
                <div class="card cardbackground">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Cannot modify" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="Cannot modify" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Cannot modify" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                         ...
                         <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <asp:DropDownList Class="form-control " ID="DropDownList1" runat="server" ReadOnly="True" Enabled="False">
                                        ...
                                        <asp:ListItem Text="Cannot modify" Value="Select" />
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="Cannot modify" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="Cannot modify" ReadOnly="True"></asp:TextBox>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" placeholder="Cannot modify" ReadOnly="True"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Cannot modify" TextMode="Number" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox9" runat="server" placeholder="Cannot modify" TextMode="Date" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-3 ">
                     <div class="row"> 
                        <div class="card p-3 border border-secondary cardbackground" style="width: 18rem;">
                            <img class="card shadow bg-white rounded " src="imgs/tr_transport_home/tr_home3.jpg" />      
                        </div>   
                    </div>

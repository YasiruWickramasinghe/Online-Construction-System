<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="supplierlogin.aspx.cs" Inherits="Construction_Project.supplierlogin" %>
            ...
            <div class="col-md-6 mx-auto">
                <div class="card">
                    <div class="card-body"> 
                        <div class="row">
                            <div class="col-12">
                                <center><img width="150px" src="imgs/userpic.png" />
                                </center>
                                </div>
                        </div>

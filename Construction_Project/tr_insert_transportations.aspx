<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="tr_insert_transportations.aspx.cs" Inherits="Construction_Project.tr_insert_transportations" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <asp:Button ID="Demo" runat="server" Text="Demo" OnClick="Demo_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
                     ...
                     <div class="row"> 
                        <div class="card p-3 border border-secondary cardbackground" style="width: 18rem;">
                            ...
                            <div class="card-body ">
                                ...
                                <asp:Button class="btn btn-outline-primary btn-sm btn-block" ID="Button1" runat="server" Text="VIEW" OnClick="Button1_Click" />

<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="tr_update_vehicles.aspx.cs" Inherits="Construction_Project.tr_update_vehicles" %>
                ...
                <div class="card cardbackground">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="EX: NB-1965" ></asp:TextBox>
                                </div>
                            </div>
                        </div>

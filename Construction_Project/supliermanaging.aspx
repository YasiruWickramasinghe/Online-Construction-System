<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="supliermanaging.aspx.cs" Inherits="Construction_Project.supliermanaging" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="imgs/cuser.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Password ID"></asp:TextBox>
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User Permanently" OnClick="Button2_Click" />
                         <asp:Button ID="Button1" class="btn btn-lg btn-block btn-warning" runat="server" Text="Download PDF" OnClick="Button1_Click"  />
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="col-md-6">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Construction_CompanyConnectionString %>"  SelectCommand="SELECT * FROM [Supplier]"></asp:SqlDataSource>
                     <div class="col-5">
                            <asp:GridView  class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="password" DataSourceID="SqlDataSource1">
                             <Columns>

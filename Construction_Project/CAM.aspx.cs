    ...
    public partial class CAM : System.Web.UI.Page
    {
        ...
        void deleteCustomer()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("DELETE from Customer  WHERE NIC= '" + TextBox3.Text + "'", con);
        ...
        bool checkIfCustomerExists()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * from Customer where NIC='" + TextBox3.Text.Trim() + "';", con);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            Paragraph para = new Paragraph("Customer Details Report", FontFactory.GetFont("Arial", 20, iTextSharp.text.Font.BOLD));
